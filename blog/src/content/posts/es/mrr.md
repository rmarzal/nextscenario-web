---
title: 'MRR Monthly Recurrent Revenue: Fórmulas y consejos para calcularlo'
description: 'El MRR o monthly recurrent revenue es el núcleo de los ingresos en un negocio Saas, ya que representa el ingreso recurrente mensual de las suscripciones activas…'
slug: 'mrr'
pubDate: '2024-11-25T10:36:15Z'
updatedDate: '2025-04-25T07:21:30Z'
lang: 'es'
tags: []
heroImage: 'https://nextscenario.com/wp-content/uploads/2024/02/movimientos-de-mrr-1024x477.png'
heroAlt: 'MRR Monthly Recurrent Revenue: Fórmulas y consejos para calcularlo'
translationOf: ""
author: 'Ruben'
...
![](https://nextscenario.com/wp-content/uploads/2024/02/movimientos-de-mrr-1024x477.png)

## Cómo calcular el [MRR ](/es?p=13372)
...
![](https://nextscenario.com/wp-content/uploads/2024/01/MRR-movemens-1024x387.png)
...
Ahora, ¡las observaciones que podemos hacer! 
  ...
  * Si no hubiéramos desglosado este MRR por tipo, todo lo que veríamos sería _"¡Viva! ¡2.620 $ de crecimiento!"._ Nos perderíamos el hecho de que hemos batido más de 4.500 $ en ingresos... que es algo en lo que hay que trabajar. 
...
Además, es muy caro mantener a todos esos usuarios gratuitos. Las grandes empresas de capital riesgo con 10 ó 100 millones en el banco pueden permitirse mantener una gran base de usuarios gratuitos. _Tú no puedes._
...
Cuando quieras empezar a hablar de términos y cifras contables, te interesarán la Contabilización, la Facturación y los Ingresos diferidos. Pero MRR _no_ es una cifra que vayas a utilizar con tu contable. 

Los Ingresos Recurrentes Mensuales están pensados para hacer un seguimiento de las tendencias de crecimiento y darte una idea de dónde procede el crecimiento de los ingresos. Puedes leer más en profundidad sobre esto [aquí](https://baremetrics.com/academy/mrr-vs-accounting-revenue). 
...
No ayudas a nadie inflando artificialmente tu cifra de MRR con clientes que _podrían_ empezar a pagarte. 
...
Cada tipo de MRR cuenta una historia y te da una idea del "por qué". Si sólo te fijas en la cifra de MRR de nivel superior, es muy posible que estés pasando por alto grandes señales de alarma, como una alta rotación que _actualmente está_ enmascarada por un alto crecimiento (pero que definitivamente no lo estará para siempre). 

**6\. Ignorar cupones y descuentos**

Tengamos un rápido intercambio de opiniones. _¿Realmente_ crees que deberías incluir el valor total de un cliente de 250 $/mes si le estás dando un cupón de descuento del 50%? No, no deberías. 

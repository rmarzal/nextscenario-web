---
title: 'Leads, Users, Active Users and Customers. Who is who in a'
description: 'I am going to talk about the most important B2b saas metrics and objectives, that will help you measure your success and make decisions based on the right data.'
slug: 'saas-users-and-active-users'
pubDate: '2023-11-07T13:40:29Z'
updatedDate: '2025-04-25T07:25:20Z'
lang: 'en'
tags: []
heroImage: 'https://nextscenario.com/wp-content/uploads/2023/11/f-1024x537-1.jpeg'
heroAlt: 'Leads, Users, Active Users and Customers. Who is who in a'
translationOf: ""
author: 'nextscenario'
...
What is it a lead? What is a saas user? What is an active user?

![](https://nextscenario.com/wp-content/uploads/2023/11/f-1024x537-1.jpeg)
...
![](https://nextscenario.com/wp-content/uploads/2023/11/b-1.gif)

I assure you that it is not an easy task, but we will try to bring some light to the topic.

> _There are metrics, processes and business objectives that must be well defined from the beginning, in order to be able to analyze in conditions the metrics that are generated for the following stages, even for internal communication or with investors._
...
This is han example of saas funnel metrics with the different metrics

![](https://nextscenario.com/wp-content/uploads/2023/11/1_gVRqYWhqQwUBzgI65Ji2Ew.png)
...
![](https://nextscenario.com/wp-content/uploads/2023/11/c.gif)
...
Defining an active user is not a trivial task. To do so, you must identify the key actions that a user must perform in your saas. Remember that an active user is an user that is far from causing churn, so it´s necessary to find the actions performed by your most loyal customers. 
...
Meanwhile this tool can help you to track your metrics:

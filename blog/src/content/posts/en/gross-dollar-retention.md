---
title: 'Gross Dollar Retention: Formula and advanced methods'
description: 'When it comes to measuring the financial health of a subscription-based business, the Gross Dollar Retention GDR formula stands out as a crucial tool. It…'
slug: 'gross-dollar-retention'
pubDate: '2024-01-23T14:18:15Z'
updatedDate: '2025-04-25T07:23:33Z'
lang: 'en'
tags: []
heroImage: ""
heroAlt: 'Gross Dollar Retention: Formula and advanced methods'
translationOf: ""
author: 'Ruben'
...
The Gross Dollar Retention formula is relatively straightforward. It involves dividing the [revenue at the end of a period](/?p=9798) by the revenue at the beginning of the period, then multiplying the result by 100 to get a percentage.
...
This is the [total revenue from existing customers](/?p=8097) at the beginning of the period you're measuring. It includes all recurring revenue sources, such as subscriptions or contracts, but excludes revenue from new customers acquired during the period.
...
Finally, investors often look at GDR rates when evaluating a company's potential for growth. A high GDR rate can make a company more attractive to investors, as it suggests a stable revenue base and the [potential for future growth](/?p=13469).

## Improving Gross Dollar Retention

Improving your Gross Dollar Retention rate involves strategies aimed at both retaining customers and [increasing their spending](/?p=13485). Here are a few strategies that can help:
...
Ready to take control of your subscription business's financial health with precision and ease? Discover how Next Scenario can revolutionize your approach to subscription analytics. With our platform, you can effortlessly connect to your payment and customer systems, gaining invaluable insights into your customer journey from acquisition to retention. Say goodbye to the tedious task of monthly reporting and reclaim a full day of work for your management team. Experience the power of real-time KPI analysis, objective setting, and forecasting with just a few clicks. [Try our free trial](https://nextscenario.com/?utm_source=landingweb&utm_medium=link&utm_campaign=home&utm_content=english) today and start making data-driven decisions that drive your business forward.

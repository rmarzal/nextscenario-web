---
title: 'Incremental Roas Vs Roas: Roas Formula and best practices'
description: 'To evaluate the effectiveness of marketing efforts and advertising campaigns, most marketers use ROAS return on advertising investment, which is calculated by…'
slug: 'incremental-roas-vs-roas-roas-formula-and-best-practices'
pubDate: '2024-04-06T14:44:04Z'
updatedDate: '2025-04-25T07:23:20Z'
lang: 'en'
tags: []
heroImage: 'https://nextscenario.com/wp-content/uploads/2024/05/ads-spend@2x-1024x550.png'
heroAlt: 'Incremental Roas Vs Roas: Roas Formula and best practices'
translationOf: 'roas-marginal-vs-roas-como-calcular'
author: 'Ruben'
...
![ ROAS PER DATASOURCE ](https://nextscenario.com/wp-content/uploads/2024/05/ads-spend@2x-1024x550.png) ROAS PER DATASOURCE 
...
ads spend dashboards

In the Nextscenario tool you can connect your ad channels and automatically calculate your ROI.

Free trial on Nextscenario
...
One of the problems you may face if you have a long sales cycle or deferred revenue is that you may have difficulty calculating ROAS and marginal ROAS in real time. In this case, using predictive revenue calculation models could be helpful. For example, in [Nextscenario.com ](http://nextscenario.com/es)we have developed such models to predict future sales and LTVs of customers.
...
![ROAS PER DATASOURCE@2x](https://nextscenario.com/wp-content/uploads/2024/05/ROAS-PER-DATASOURCE@2x-1024x628.png)ROAS PER DATASOURCE@2x
...
Incrementality is something to keep in mind when measuring marketing results and planning new investments. If you don't take it into account, you can end up with inadequate estimates and excessive ad spend. To help you save more money, at [Nextscenario.com ](http://nextscenario.com/)we have developed a predictive model to optimize advertising campaigns that takes into account both incremental costs and real-time user behavior, which you can try for free here: [Nextscenario.com](http://nextscenario.com/ecommerce/)

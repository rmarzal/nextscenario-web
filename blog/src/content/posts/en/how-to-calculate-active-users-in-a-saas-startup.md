---
title: 'How to calculate active users in a saas startup'
description: 'https://nextscenario.com/wp-content/uploads/2023/11/Active-users-1024x528-1-1.jpg — practical deep dive from the NextScenario team.'
slug: 'how-to-calculate-active-users-in-a-saas-startup'
...
heroAlt: 'How to calculate active users in a saas startup'
translationOf: 'como-calcular-usuarios-activos-en-un-saas-2'
author: 'nextscenario'
migratedFrom: 'https://nextscenario.com/how-to-calculate-active-users-in-a-saas-startup/'
needsReview: false
draft: false
---
...
There are several problems with the DAU:
  ...
  1. They are not actionable. You can’t do anything with a DAU that goes down, except wonder what went wrong.
  2. It is a metric that can be easily skewed and manipulated.
  3. One startup calculates active users differently than another, which makes them complicated to benchmark.
...
![](https://nextscenario.com/wp-content/uploads/2023/11/d-2.png)
...
![](https://nextscenario.com/wp-content/uploads/2023/11/1Active-users-1024x528-1-1.jpg)
...
### How to define an Active user in a saas model:
  ...
  1. Determine the time period you are interested in examining (day, week, month…).
  2. Identify, define and measure the set of actions to be performed by a user
  3. Don’t put the cart before the horse, start simple and as you get to know your users, start specifying more. Don’t complicate the measurement before the time

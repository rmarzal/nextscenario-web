...
description: 'There are many models to explain the customer life, but until now I had´t found one that applied completely to a SaaS business model, covering all its…'
slug: 'b2b-saas-metrics-journey-framework'
...
[Saas business plan template](https://nextscenario.com/old/saas-business-plan-template/)
...
**[Users, Activer users, Subscribers](https://nextscenario.com/old/how-to-calculate-active-users-in-a-saas-startup/)**
...
**Data sources:[Google Analytics.](https://marketingplatform.google.com/about/)**
...
> _💡It is advisable in initial phases, don ´t impute team expenses, they can distort this metric, as they don´t capture large masses of customers._

> _In this case, we can calculate a “blended Cac” with the costs of the marketing and sales teams, if we have inbound and outbound strategies and calculate the Cac only for marketing campaigns. This would not apply if we only have sales teams._
...
> _💡Counting LifeTime users to calculate the LTV can distort our Churn. It is advisable not to take these users into account when calculating the operating Churn._
...
> _Churn below 5% per month is positive, churn above 5% per month implies that 60% of subscribers unsubscribe per year._
...
> _In a Saas, persistently low gross margins may be evidence of a problem because the company is using humans, to realize the capabilities of the product (i.e., it is not a pure software company)._
